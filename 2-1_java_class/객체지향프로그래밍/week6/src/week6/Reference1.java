...
public class Reference1 {
    public static void main(String[] args) {
        // 기본 데이터 타입의 변수는 스택영역에 생성되면서 값도 같이 저장된다.
        int iVal1 = 100;
        int iVal2 = 100;
        ...
        System.out.println("sVal1 == sVal2: " +(sVal1 == sVal2?"참조가 같음":"참조가 다름"));     // 스택영역에 있는 메모리 주소값을 비교

        // 참조타입의 변수는 초기값으로 null 을 사용할 수 있다. (스택영역에만 생성됨)
        String sVal5 = null;
