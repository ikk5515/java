...
// 이 문제는 자바 배열에 관해서 2차원 배열 위주로 생성 및 출력을 다양하게 해보는 종합문제 입니다.


public class array_OneTwoArray {
    public static void main(String[] args) {

        // [1]: String 1차원 배열 --> 3개 문자열을 담을 수 있는 배열 생성하기
        // String 타입의 참조 변수 3개를 저장하기 위한 공간 생성 --> 이때, 참조형 변수 각 요소의 기본값 --> null로 초기화.
        ...
        System.out.println(Asia_nations[1][0]);     // 태국 : 실제 요소의 값 출력
        ...
        System.out.println(strAr[1].charAt(2));     // m 출력
        System.out.println(strAr[2].charAt(2));     // r 출력

        // [9]: 반복문에서 charAt() 메서드 사용
        // [9-1] 잘못된 예1
        for (int i = 0; i < strAr.length; i++) {
            System.out.print(strAr[i].charAt(i));   // Hir  --> 이중 반복문을 사용하여 Hong Kim Park 출력 가능.
        }
        System.out.println();

        // [9-2] 잘못된 예2
        for (int i = 0; i < strAr.length; i++) {
            for (int j = 0; j < strAr.length; j++) {    // j가 3까지만 반복되므로 잘못됨.
        ...
        // [10]: length vs length()     // 배열의 길이 vs 문자열의 길이
        int[] aaa = new int[10];
